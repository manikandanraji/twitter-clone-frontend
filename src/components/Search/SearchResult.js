...
const SearchResult = ({ searchTweetLoading, searchUserLoading, searchTagLoading, tags, users, tweets }) => {
	...
	return (
		<Wrapper>
			...
			{searchResultAction === "TAGS" && <SearchResultTags tags={tags} loading={searchTagLoading}/>}
			{searchResultAction === "USERS" && <SearchResultUsers users={users} loading={searchUserLoading}/>}
		</Wrapper>
	);
};
